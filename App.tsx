...
const CLIENT_REPORTS: Record<string, ClientReport> = {
  "余忠祐": {
    content: "忠祐您好，這是為您整理的最新投資績效摘要：\n\n過，幫你做過標的轉換。這是一整年最新績效：(新)安聯台灣科技： 累積報酬率已經來到 98.13%。總體帳戶價值：從去年 2 月初的 123,375 成長到現在的 220,309。總體帳戶價值：從去年 2 月初的 123,375 成長到現在的 220,309。整體報酬率：累計也達到了 81.27%。這就是我們定期檢視，隨時因應市場調整標的的意義。",
    date: "2025/02/03",
