  ...
  "王韻雅": {
    ...
    investment: {
      ...
      sections: [
        {
          title: "績效總結回顧",
          content: "Coco您好，年前特別為您更新定期定額績效。還記得 2023 年市場最震盪的時候嗎？我知道您也懷疑過，甚至有過想放棄的念頭。在過去一年的市場波動中，目前您的整體資產配置表現相當亮眼！這就是堅持長期投資最好的回報！"
        },
        {
          title: "核心持股表現",
 ...
 "黃志宇": {
  ...
  "蔡咏純": {
    password: "CMPY", 
     investment: {
      date: "2026/02/12",
      imageUrl: "https://i.postimg.cc/Nfbbcxfr/IMG-0263.jpg",
      sections: [
        {
          title: "績效總結回顧",
          content: "咏純您好，年前特別為您更新定期定額績效。在過去一年的市場波動中，目前您的整體資產配置表現相當亮眼！這就是堅持長期投資最好的回報！"
        },
        {
          title: "核心持股表現",
          content: "目前標的連結50%台股+50%美股基金，其中「安聯台灣大壩」，這檔台股基金累積報酬率已來到 119.96%。總體帳戶價值從去年 2 月初的 43,616 成長到現在的 97,729。"
        },
        {
          title: "我的建議",
          content: "很開心能陪您一起見證這段時間的資產成長，這證明了我們當時的選擇是正確的！目前科技產業的長線動能還是很強，已經抓對了趨勢，可以善用年終紅包加碼，累積更多本金。除了守住原本的獲利，也配置一些不同標的來讓組合更完整。持續定期定額，讓時間幫我們複利！"
  ...
  "蕭敦峻": {
    password: "LXOE", 
     investment: {
      date: "2026/02/12",
      imageUrl: "https://i.postimg.cc/tTxp0T3d/IMG-0266.jpg",
      sections: [
        {
          title: "績效總結回顧",
          content: "敦峻您好，年前特別為您更新定期定額績效。在過去一年的市場波動中，目前您的整體資產配置表現相當亮眼！這就是堅持長期投資最好的回報！"
        },
        {
          title: "核心持股表現",
          content: "目前標的連結50%台股+50%美股基金，其中「安聯台灣大壩」，這檔台股基金累積報酬率已來到 120.66%。總體帳戶價值從去年 2 月初的310,959 成長到現在的 518,675。"
        },
        {
          title: "我的建議",
          content: "很開心能陪您一起見證這段時間的資產成長，這證明了我們當時的選擇是正確的！目前科技產業的長線動能還是很強，已經抓對了趨勢，可以善用年終紅包加碼，累積更多本金。除了守住原本的獲利，也配置一些不同標的來讓組合更完整。持續定期定額，讓時間幫我們複利！"
  ...
  "蕭敦育": {
    password: "XOEN", 
     investment: {
      date: "2026/02/12",
      imageUrl: "https://i.postimg.cc/tJv5hXc6/IMG-0268.jpg",
      sections: [
        {
          title: "績效總結回顧",
          content: "敦育您好，年前特別為您更新定期定額績效。在過去一年的市場波動中，目前您的整體資產配置表現相當亮眼！這就是堅持長期投資最好的回報！"
        },
        {
          title: "核心持股表現",
          content: "目前標的連結50%台股+50%美股基金，其中「安聯台灣大壩」，這檔台股基金累積報酬率已來到 149.01%。總體帳戶價值從去年 2 月初的248,810 成長到現在的 480,493。"
        },
        {
          title: "我的建議",
          content: "很開心能陪您一起見證這段時間的資產成長，這證明了我們當時的選擇是正確的！目前科技產業的長線動能還是很強，已經抓對了趨勢，可以善用年終紅包加碼，累積更多本金。除了守住原本的獲利，也配置一些不同標的來讓組合更完整。持續定期定額，讓時間幫我們複利！"
  ...
  "陳奕安": {
    password: "EPSV", 
     investment: {
      date: "2026/02/12",
      imageUrl: "https://i.postimg.cc/26DrDY0r/IMG-0269.jpg",
      sections: [
        {
          title: "績效總結回顧",
          content: "奕安您好，年前特別為您更新定期定額績效。在過去一年的市場波動中，目前您的整體資產配置表現相當亮眼！這就是堅持長期投資最好的回報！"
        },
        {
          title: "核心持股表現",
          content: "目前標的連結70%台股+30%美股基金，其中「安聯台灣大壩」，這檔台股基金累積報酬率已來到 118.24%。去年新配置的「安聯台灣科技」不到一年報酬率已來到130.98%。總體帳戶價值從去年 2 月初的101,667 成長到現在的 262,472。"
        },
        {
          title: "我的建議",
          content: "很開心能陪您一起見證這段時間的資產成長，這證明了我們當時的選擇是正確的！目前科技產業的長線動能還是很強，持續定期定額，讓時間幫我們複利！"
        }
      ]
    },
    medical: {
   ...
   "陳泱蓉": {
    password: "ERUD", 
     investment: {
      date: "2026/02/12",
      imageUrl: "https://i.postimg.cc/DyLV7Hb0/IMG-0270.jpg",
      sections: [
        {
          title: "績效總結回顧",
          content: "泱蓉您好，年前特別為您更新定期定額績效。在過去一年的市場波動中，目前您的整體資產配置表現相當亮眼！這就是堅持長期投資最好的回報！"
        },
        {
          title: "核心持股表現",
          content: "目前標的連結50%台股+50%美股基金，其中「安聯台灣大壩」，這檔台股基金累積報酬率已來到 135.00%。總體帳戶價值從去年 2 月初的74,012 成長到現在的 144,654。"
        },
        {
          title: "我的建議",
          content: "很開心能陪您一起見證這段時間的資產成長，這證明了我們當時的選擇是正確的！目前科技產業的長線動能還是很強，持續定期定額，讓時間幫我們複利！"
   ...
   "蔡懷德": {
    password: "KDTA", 
     investment: {
      date: "2026/02/12",
      imageUrl: "https://i.postimg.cc/4dYYwzn7/IMG-0273.jpg",
      sections: [
        {
          title: "績效總結回顧",
          content: "懷德您好，年前特別為您更新定期定額績效。在過去一年的市場波動中，目前您的整體資產配置表現相當亮眼！這就是堅持長期投資最好的回報！"
        },
        {
          title: "核心持股表現",
          content: "目前標的連結30%台股+70%美股基金，其中「安聯台灣大壩」，這檔台股基金累積報酬率已來到 146.94%。總體帳戶價值從去年 2 月初的229,358 成長到現在的 338,468。"
        },
        {
          title: "我的建議",
          content: "很開心能陪您一起見證這段時間的資產成長，這證明了我們當時的選擇是正確的！目前科技產業的長線動能還是很強，已經抓對了趨勢，可以善用年終紅包加碼，累積更多本金。除了守住原本的獲利，也配置一些不同標的來讓組合更完整。持續定期定額，讓時間幫我們複利！"
